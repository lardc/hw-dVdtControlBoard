...
#define DATA_TABLE_BASE_SIZE		320
#define DATA_TABLE_SIZE_PLUS_EXT	640
#define DATA_TABLE_NV_EXT_SIZE		(DATA_TABLE_SIZE_PLUS_EXT - DATA_TABLE_BASE_SIZE)
//
